...
export const columns = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can update their own columns", {
      as: "permissive",
      for: "update",
      to: ["authenticated"],
    }),
...
export const coverLetters = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can update their own cover_letters", {
      as: "permissive",
      for: "update",
      to: ["public"],
    }),
...
export const templates = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can delete own templates", {
      as: "permissive",
      for: "delete",
      to: ["authenticated"],
      using: sql`(auth.uid() = user_id)`,
    }),
    pgPolicy("Users can read own templates", {
      as: "permissive",
      for: "select",
      to: ["authenticated"],
    }),
    pgPolicy("Users can insert own templates", {
      as: "permissive",
      for: "insert",
      to: ["authenticated"],
    }),
    pgPolicy("Users can update own templates", {
      as: "permissive",
      for: "update",
      to: ["authenticated"],
    }),
...
export const jobApplications = pgTable(
  ...
  (table) => [
    ...
    pgPolicy("Users can update their own job_applications", {
      as: "permissive",
      for: "update",
      to: ["public"],
    }),
